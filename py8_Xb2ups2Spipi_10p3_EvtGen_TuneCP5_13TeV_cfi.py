# cfg file for X_b -> Ups(2S) pion+ pion-. Masses and widths are matched between pythia, evtgen and PDG 2016
#The mass of the chi_b0(1P) is set to 10.3 GeV (desired resonant mass)
...
Particle chi_b0  10.300000 0.00000
...
upsIDfilter = cms.EDFilter("MCSingleParticleFilter",
    ParticleID = cms.untracked.vint32(100553),  #Y(2S)
