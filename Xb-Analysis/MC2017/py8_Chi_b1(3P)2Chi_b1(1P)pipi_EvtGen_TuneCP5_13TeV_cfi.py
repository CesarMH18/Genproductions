# cfg file for Chi_b1(3P) -> Chi_b1(1P) pion+ pion-. Masses and widths are matched between pythia, evtgen and PDG 2016
...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            list_forced_decays = cms.vstring('myChib3P'),       
            operates_on_particles = cms.vint32(220553),        
            convertPythiaCodes = cms.untracked.bool(False),
            user_decay_embedded= cms.vstring(
"""
Particle Upsilon 9.4603000 0.00005402
Particle chi_b1  9.8927800 0.00000
Particle chi_b1(3P)  10.5134000 0.00000

Alias myUpsilon Upsilon
Alias mychi_b1  chi_b1
Alias myChib3P  chi_b1(3P) 
...
# We will filter for chi_b1(3P), and chi_b1(1P), first on the ID, then in the mass, this will constraint the photon daughter

pwaveIDfilterchi3P = cms.EDFilter("MCSingleParticleFilter",
    ParticleID = cms.untracked.vint32(220553),
...
piminusfilter = cms.EDFilter("PythiaDauVFilter",
    ...
    ParticleID = cms.untracked.int32(220553),
    ChargeConjugation = cms.untracked.bool(False),
    MinEta = cms.untracked.vdouble(-2.4),
    MaxEta = cms.untracked.vdouble(2.4),
    NumberDaughters = cms.untracked.int32(1),
...
ProductionFilterSequence = cms.Sequence(generator*pwaveIDfilterchi3P*pwaveIDfilterchi*pwaveMassfilter*piminusfilter*piplusfilter*muminusfilter*muplusfilter)
